...
thirdperson_thirdobviative = {
    ...
    '2S_3P_con_jh': ['eh', 'âcik'],         # Them/NA(pl) ___ing 3' (Beginning -h- joiner)
...
secondperson_firstperson = {
    ...
    '2P_1S_ind_jtb': ['kit', 'in'],         # You ____________ me (Beginning -t- joiner)

    '2S_1P_ind': ['ki', 'inân'],            # You ____________ us
    '2S_1P_ind_jtb': ['kit', 'inân'],       # You ____________ us (Beginning -t- joiner)

    '2P_1S_ind': ['ki', 'inâwâw'],          # You (pl) _______ me
    '2P_1S_ind_jtb': ['kit', 'inâwâw'],     # You (pl) _______ me (Beginning -t- joiner)
...
secondperson_firstperson = {
    ...
    '1S_2S_ind_jtb_vca': ['kit', 'âtinân'], # We ___________ you (Beginning -t- joiner, and â vowel change)
    '1S_2S_ind_jtb_vci': ['kit', 'îtinân'], # We ___________ you (Beginning -t- joiner, and î vowel change)
    '1S_2S_ind_jtb_vco': ['kit', 'ôtinân'], # We ___________ you (Beginning -t- joiner, and ô vowel change)

    '1S_2P_ind': ['ki', 'itinâwâw'],        # I ____________ you (pl)
    '1S_2P_ind_jtb': ['kit', 'itinâwâw'],   # I ____________ you (pl) (Beginning -t- joiner)
    '1S_2P_ind_jtf': ['ki', 'titinâwâw'],   # I ____________ you (pl) (Final -t- joiner)
    '1S_2P_ind_jtbf': ['kit', 'titinâwâw'], # I ____________ you (pl) (Beginning -t- joiner, and final -t- joiner)
    '1S_2P_ind_vca': ['ki', 'âtinâwâw'],    # I ____________ you (pl) (â vowel change)
    '1S_2P_ind_vci': ['ki', 'îtinâwâw'],    # I ____________ you (pl) (î vowel change)
    '1S_2P_ind_vco': ['ki', 'ôtinâwâw'],    # I ____________ you (pl) (ô vowel change)
    '1S_2S_ind_jtb_vca': ['kit', 'âtinâwâw'],# I ____________ you (pl) (Beginning -t- joiner, and â vowel change)
    '1S_2S_ind_jtb_vci': ['kit', 'îtinâwâw'],# I ____________ you (pl) (Beginning -t- joiner, and î vowel change)
    '1S_2S_ind_jtb_vco': ['kit', 'ôtinâwâw'],# I ____________ you (pl) (Beginning -t- joiner, and ô vowel change)

    '1P_2P_ind': ['ki', 'titinân'],         # We ___________ you (pl)
    '1P_2P_ind_jtb': ['kit', 'titinân'],    # We ___________ you (pl) (Beginning -t- joiner)
    '1P_2P_ind_jtf': ['ki', 'titinân'],     # We ___________ you (pl) (Final -t- joiner)
    '1P_2P_ind_jtbf': ['kit', 'titinân'],   # We ___________ you (pl) (Beginning -t- joiner, and final -t- joiner)
    '1P_2P_ind_vca': ['ki', 'âtinân'],      # We ___________ you (pl) (â vowel change)
    '1P_2P_ind_vci': ['ki', 'îtitinân'],    # We ___________ you (pl) (î vowel change)
    '1P_2P_ind_vco': ['ki', 'ôtitinân'],    # We ___________ you (pl) (ô vowel change)
    '1S_2S_ind_jtb_vca': ['kit', 'âtitinân'],# We ___________ you (pl) (Beginning -t- joiner, and â vowel change)
    '1S_2S_ind_jtb_vci': ['kit', 'îtitinân'],# We ___________ you (pl) (Beginning -t- joiner, and î vowel change)
    '1S_2S_ind_jtb_vco': ['kit', 'ôtitinân'],# We ___________ you (pl) (Beginning -t- joiner, and ô vowel change)

    '1S_2S_con': ['e', 'itân'],             # I am _________ing you
    '1S_2S_con_jhb': ['eh', 'itân'],        # I am _________ing you (Beginning -h- joiner)
    '1S_2S_con_jtf': ['e', 'titân'],        # I am _________ing you (Final -t- joiner)
    '1S_2S_con': ['eh', 'titân'],           # I am _________ing you (Beginning -h- joiner, and final -t- joiner)
    '1S_2S_con_vca': ['e', 'âtân'],         # I am _________ing you (â vowel change)
    '1S_2S_con_vci': ['e', 'îtân'],         # I am _________ing you (î vowel change)
    '1S_2S_con_vco': ['e', 'ôtân'],         # I am _________ing you (ô vowel change)
    '1S_2S_con_jtb_vca': ['eh', 'âtân'],    # I am _________ing you (Beginning -h- joiner, and â vowel change)
    '1S_2S_con_jtb_vci': ['eh', 'îtân'],    # I am _________ing you (Beginning -h- joiner, and î vowel change)
    '1S_2S_con_jtb_vco': ['eh', 'ôtân'],    # I am _________ing you (Beginning -h- joiner, and ô vowel change)

    '1P_2P_con': ['e', 'itâhk'],            # We are _______ing you
    '1P_2P_con_jhb': ['eh', 'itâhk'],       # We are _______ing you (Beginning -h- joiner)
    '1P_2P_con_jtf': ['e', 'itâhk'],        # We are _______ing you (Final -t- joiner)
    '1P_2P_con': ['eh', 'itâhk'],           # We are _______ing you (Beginning -h- joiner, and final -t- joiner)
    '1P_2P_con_vca': ['e', 'âtâhk'],        # We are _______ing you (â vowel change)
    '1P_2P_con_vci': ['e', 'îtâhk'],        # We are _______ing you (î vowel change)
    '1P_2P_con_vco': ['e', 'ôtâhk'],        # We are _______ing you (ô vowel change)
    '1S_2S_con_con_vca': ['eh', 'âtâhk'],   # We are _______ing you (Beginning -h- joiner, and â vowel change)
    '1S_2S_con_jtb_vci': ['eh', 'îtâhk'],            # We are _______ing you (Beginning -h- joiner, and î vowel change)
    '1S_2S_con_jtb_vco': ['eh', 'ôtâhk'],            # We are _______ing you (Beginning -h- joiner, and ô vowel change)

    '1S_2P_con': ['e', 'itakok'],           # I am _________ing you (pl)
    '1S_2P_con_jhb': ['eh', 'itakok'],           # I am _________ing you (pl) (Beginning -h- joiner)
    '1S_2P_con_jtf': ['e', 'titakok'],       # I am _________ing you (pl) (Final -t- joiner)
    '1S_2P_con': ['eh', 'titakok'],           # I am _________ing you (pl) (Beginning -h- joiner, and final -t- joiner)
    '1S_2P_con_vca': ['e', 'âtakok'],        # I am _________ing you (pl) (â vowel change)
    '1S_2P_con_vci': ['e', 'îtakok'],           # I am _________ing you (pl) (î vowel change)
    '1S_2P_con_vco': ['e', 'ôtakok'],           # I am _________ing you (pl) (ô vowel change)
    '1S_2S_con_jtb_vca': ['eh', 'âtakok'],           # I am _________ing you (pl) (Beginning -h- joiner, and â vowel change)
    '1S_2S_con_jtb_vci': ['eh', 'îtakok'],           # I am _________ing you (pl) (Beginning -h- joiner, and î vowel change)
    '1S_2S_con_jtb_vco': ['eh', 'ôtakok'],           # I am _________ing you (pl) (Beginning -h- joiner, and ô vowel change)

    '1P_2P_con': ['e', 'itâhk'],            # We are _______ing you (pl)
    '1P_2P_con_jhb': ['eh', 'itâhk'],            # We are _______ing you (pl) (Beginning -h- joiner)
    '1P_2P_con_jtf': ['e', 'titâhk'],        # We are _______ing you (pl) (Final -t- joiner)
    '1P_2P_con': ['eh', 'titâhk'],            # We are _______ing you (pl) (Beginning -h- joiner, and final -t- joiner)
    '1P_2P_con_vca': ['e', 'âtâhk'],         # We are _______ing you (pl) (â vowel change)
    '1P_2P_con_vci': ['e', 'îtâhk'],            # We are _______ing you (pl) (î vowel change)
    '1P_2P_con_vco': ['e', 'ôtâhk'],            # We are _______ing you (pl) (ô vowel change)
    '1S_2S_con_jtb_vca': ['eh', 'âtâhk'],            # We are _______ing you (pl) (Beginning -h- joiner, and â vowel change)
    '1S_2S_con_jtb_vci': ['eh', 'îtâhk'],            # We are _______ing you (pl) (Beginning -h- joiner, and î vowel change)
    '1S_2S_con_jtb_vco': ['eh', 'ôtâhk'],            # We are _______ing you (pl) (Beginning -h- joiner, and ô vowel change)
}
